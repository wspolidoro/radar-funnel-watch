    ...
    <div className="container max-w-4xl py-8 space-y-6">
      ...
      <header className="space-y-2">
        <h1 className="text-3xl font-bold flex items-center gap-3">
          Configuração: <span className="text-primary">{domain.domain}</span>
        </h1>
        <p className="text-muted-foreground">
          Gerencie o apontamento e monitore a chegada de requisições do Maileroo.
        </p>
      </header>
      ...
      <Tabs defaultValue="config" className="space-y-6">
        <TabsList className="grid w-full grid-cols-2 max-w-[400px]">
          ...
          <TabsTrigger value="logs" className="gap-2">
            <Activity className="h-4 w-4" /> Roteamento & Logs
          </TabsTrigger>
        </TabsList>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 bg-background border rounded-lg space-y-3 font-mono text-sm">
                  ...
                  <div className="grid grid-cols-4 gap-2 items-center">
                    ...
                    <span>@</span>
                    <span className="col-span-2 flex items-center justify-between bg-muted p-1 px-2 rounded truncate">
                      mx.maileroo.com
                      <Button variant="ghost" size="icon" onClick={() => copyToClipboard('mx.maileroo.com')} className="h-6 w-6 shrink-0">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-muted rounded-lg font-mono text-xs overflow-hidden">
                    <span className="truncate flex-1">{webhookUrl}</span>
                    <Button variant="outline" size="sm" onClick={() => copyToClipboard(webhookUrl)} className="gap-2 shrink-0">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <ol className="list-decimal list-inside space-y-1">
                    ...
                    <li>Vá em <strong>Inbound Routing</strong></li>
            ...
            <div className="flex items-center justify-between p-4 border rounded-xl bg-primary/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Assim que o primeiro e-mail chegar, ele aparecerá na aba de logs ao lado.</p>
                </div>
              </div>
        ...
        <TabsContent value="logs">
          <RoutingLogs domain={domain.domain} />
        </TabsContent>
      </Tabs>
    </div>
  );
